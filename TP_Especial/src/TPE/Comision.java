...
public class Comision extends ElementoFacultad {
	...
	public Comision(String nombre, Comparador comparador) {
		this.nombre=nombre;
		elementos = new ListaVinculada(comparador);
	}
	...
	public void setOrden(Comparador comp) {
		this.elementos.setOrden(comp);
	}
